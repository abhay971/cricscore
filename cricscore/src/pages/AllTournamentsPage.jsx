...
const AllTournamentsPage = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0B0D14]">
        <div className="text-center">
          <div className="animate-spin w-14 h-14 border-4 border-white/10 border-t-transparent rounded-full mx-auto mb-4"></div>
  ...
  return (
    <div className="min-h-screen bg-[#0B0D14] pb-24">
      ...
      <div className="px-5 pt-6 pb-6 sticky top-0 bg-[#0B0D14] z-10">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="w-full bg-white/10 text-white/70 border border-white/10 rounded-full py-4 px-6 flex items-center justify-center gap-3 font-bold text-lg transition-colors"
        >
        ...
        {tournaments.length === 0 ? (
          ...
          <div className="space-y-4">
            {tournaments.map((tournament, index) => (
              ...
              >
                {/* Header */}
                <div className="px-6 py-5 border-b border-[#1E2030]">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {tournament.customRules?.declareOneEnabled && (
                      <div className="flex items-center gap-2 px-3 py-2 bg-white/5 rounded-full border border-white/10">
                        ...
                        <span className="text-xs font-bold text-emerald-400">Declare 1</span>
                      </div>
                    )}
                  </div>
